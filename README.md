...
Se invece si vuole sperimentare online in modo interattivo con i notebook va lanciatp *Binder*.

Il caricamento sul server di *Binder* dell'intero ambiente richiede, per poter iniziare l'elaborazione, circa un minuto di attesa dopo il quale ci si trova in un ambiente dove sarà possibile selezionare il notebook e avviarne passo passo l'esecuzione oppure eseguirne tutte le sue celle (`Run\Run All Cells`).
